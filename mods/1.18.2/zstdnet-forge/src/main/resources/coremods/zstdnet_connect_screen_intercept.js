    ...
    return {
        'zstdnet_connect_screen_intercept': {
            ...
            'transformer': function(classNode) {
                // 1.18.2 的 startConnecting 同 1.19.2，没有 1.20 新增的尾部 boolean (isQuickPlay) 参数。
                var exactDesc = '(Lnet/minecraft/client/gui/screens/Screen;Lnet/minecraft/client/Minecraft;Lnet/minecraft/client/multiplayer/resolver/ServerAddress;Lnet/minecraft/client/multiplayer/ServerData;)V';
