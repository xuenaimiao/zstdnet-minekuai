...
public final class ServerProxyBootstrap {
    ...
    private static Component copyableZstdPort(int port) {
        ...
        return new TextComponent(text).withStyle(style -> style
            ...
            .withHoverEvent(new HoverEvent(HoverEvent.Action.SHOW_TEXT, new TranslatableComponent("zstdnet.singleplayer.lan_ready.copy_zstd"))));
    }
    ...
    private static void onPlayerLoggedIn(PlayerEvent.PlayerLoggedInEvent event) {
        ...
        SocketAddress remoteAddress = player.connection.connection.getRemoteAddress();
        ...
        player.connection.disconnect(new TextComponent(ServerProxyRuntime.ZSTD_ADDRESS_HINT));
    }
