...
public final class ServerRealIpHooks {
    ...
    private static final Map<ClientIntentionPacket, String> RAW_HANDSHAKE_HOSTS = Collections.synchronizedMap(new WeakHashMap<>());
    ...
    public static void rememberRawHandshakeHost(ClientIntentionPacket packet, String hostName) {
    ...
    private static String forwardedHostName(ClientIntentionPacket packet) {
        ...
        for (String methodName : new String[] {"hostName", "getHostName"}) {
            try {
                ...
                if (value instanceof String reflectedHostName) {
                    return reflectedHostName;
                }
