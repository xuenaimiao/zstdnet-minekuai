 ...
 * 仅影响走本地代理的连接；直连/非环回连接保持原版行为。与 ForceTablistHeads / TabHeads 等同类客户端 mod 思路一致，
 * 但作用范围收窄到 ZstdNet 自己的代理连接。
 */
